...
export class AuthenticationService {
  ...
  Login(credentials: { UserName: string; Password: string }): Observable<Object> {
    //http://192.119.110.192:5001/api/logindash
    return this._http.post("http://192.119.110.192:5001/api/logindash", credentials, this.httpOptions);
  }
  redirectUserBasedRole() {
    console.log("redirectUserBasedRoles");
